...
<html lang="pt-br">
	<head>
		...
		<link rel="icon" type="image/png" sizes="16x16" href="<?php echo URL; ?>app/assets/img/favicon.png">
	...
	<nav class="navbar navbar-expand-lg menu fixed-top">
		<div class="container">
			<button class="navbar-toggler mr-auto" type="button" id="sfc" data-toggle="offcanvas" aria-expanded="false">
	...
	<div class="container">
		...
		<div class="card cardapio mb-5">
		    <div class="card-deck text-center cardapio-slidder owl-carousel">
			      <div class="card">"
			        	<a href=""><img class="card-img" src="<?php echo URL; ?>app/assets/img/pizza30.png"></a>
			        	<div class="card-body">
	...
	<div class="jumbotron jumbotron-fluid noticias mb-0">
		<div class="container noticias-d">
			<div class="noticias-img mb-5">
			   <img class="noticias-image" src="<?php echo URL; ?>app/assets/img/vinho.jpg">
			</div>
			<div class="noticias-txt mt-4 text-center">
				...
				<button class="btn btn-noticias mt-5">Mais Noticias</button>
			</div>
		</div>
	</div>
	 			...
	 			<div class="testemunhos-slidder owl-carousel">
	 				<div class="testemunhos">
	 					...
	 					<div class="testemunhos-conteudo">
	 						<div class="pic">
	 							<img src="<?php echo URL; ?>app/assets/img/girl.jpg">
	 						</div>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js" integrity="sha512-bPs7Ae6pVvhOSiIcyUClR7/q2OAsRiovw4vAkX+zJbw3ShAeeqezq50RIIcIURq7Oa20rW2n2q+fyXBNcU9lrw==" crossorigin="anonymous"></script>
    ...
    <script src="<?php echo URL; ?>app/assets/js/style.js"></script>
